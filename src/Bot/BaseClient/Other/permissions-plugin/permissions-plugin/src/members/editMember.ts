...
import type { Bot, PermissionStrings } from "discordeno";
import type { BotWithProxyCache, ProxyCacheTypes } from "../../..";
export function editMember<B extends Bot>(
  ...
  bot.helpers.editMember = async function (guildId, memberId, options) {
    ...
    if (
      ...
      const memberVoiceState = (bot.cache.guilds.memory.get(bot.transformers.snowflake(guildId)))
