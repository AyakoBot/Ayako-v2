...
export const fileURL2Blob               = (await import(`./ClientHelperModules/fileURL2Blob.js`)).default;
...
export const hasGuildPermissions        = (await import(`./ClientHelperModules/hasGuildPermissions.js`)).default;
