  ...
  components: [
   {
    ...
    components: Object.entries(lan.punishmentTypes).map(([key, value]) => ({
     label: value,
     custom_id: `check/type_${key}_${baseInfo.user.id}`,
    ...
    components: [
     {
      ...
      custom_id: `check/page_${selected.type}_${baseInfo.user.id}_back_${selected.page}`,
      type: Discord.ComponentType.Button,
     ...
     },
     {
      ...
      custom_id: `check/page_${selected.type}_${baseInfo.user.id}_forth_${selected.page}`,
      type: Discord.ComponentType.Button,
      style: Discord.ButtonStyle.Secondary,
      disabled:
