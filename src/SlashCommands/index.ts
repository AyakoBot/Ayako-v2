...
export default {
 ...
 categories: {
  ...
  clear_all: [CommandCategories.Utility],
  clear_user: [CommandCategories.Utility],
  clear_between: [CommandCategories.Utility],
  clear_match: [CommandCategories.Utility],
  'clear_not-match': [CommandCategories.Utility],
  'clear_starts-with': [CommandCategories.Utility],
  'clear_ends-with': [CommandCategories.Utility],
  clear_includes: [CommandCategories.Utility],
  clear_links: [CommandCategories.Utility],
  clear_invites: [CommandCategories.Utility],
  clear_images: [CommandCategories.Utility],
  clear_videos: [CommandCategories.Utility],
  clear_files: [CommandCategories.Utility],
  clear_audio: [CommandCategories.Utility],
  clear_mentions: [CommandCategories.Utility],
  clear_stickers: [CommandCategories.Utility],
  clear_embeds: [CommandCategories.Utility],
  clear_text: [CommandCategories.Utility],
  clear_humans: [CommandCategories.Utility],
  clear_bots: [CommandCategories.Utility],
