...
export default {
 ...
 commands: {
  interactions: [
   ...
   { name: 'facepalm', desc: 'Facepalm', users: true, reqUser: false },
   {
    name: 'feed',
    desc: 'Feed someone',
    users: true,
   ...
   { name: 'kidnap', desc: 'Kidnap someone', users: true, reqUser: true, buttons: ['run'] },
   ...
   { name: 'lift', desc: 'Lift someone', users: true, reqUser: true, buttons: ['bite', 'happy'] },
   ...
   { name: 'run', desc: 'Run away', users: true, reqUser: false },
   ...
   { name: 'shrug', desc: 'Shrug', users: true, reqUser: false },
   { name: 'sigh', desc: 'Sigh', users: true, reqUser: false },
   ...
   { name: 'think', desc: 'Think', users: true, reqUser: false },
   {
    name: 'thumbsup',
   ...
   { name: 'wink', desc: 'Wink', users: true, reqUser: false },
   { name: 'yeet', desc: 'Yeet someone', users: true, reqUser: true },
   ...
   { name: 'nope', desc: "I'm outta here", users: true, reqUser: false },
  ] as const,
  settings: {
