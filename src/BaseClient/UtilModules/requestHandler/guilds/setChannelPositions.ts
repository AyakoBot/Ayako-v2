...
export default async (
 ...
 if (!canSetChannelPositions(await guild.client.util.getBotMemberFromGuild(guild))) {
  const e = guild.client.util.requestHandlerError(`Cannot set channel positions`, [
